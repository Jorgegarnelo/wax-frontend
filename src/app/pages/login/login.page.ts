...
export class LoginPage implements OnInit, OnDestroy {
  ...
  ionViewWillEnter() {
    ...
    // Solo resetea el mensaje si no venimos de verificar email
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe(params => {
      if (params['verified'] === 'true') {
        ...
        this.successMessage = '✓ Email verificado correctamente. Introduce tus credenciales para iniciar sesión.';
      }
    });
  }
    ...
    this.authService.register(value)
      ...
      .subscribe({
        next: (res: any) => {
          ...
          this.successMessage = res.message || 'Cuenta creada. Revisa tu email para verificar tu cuenta.';
          this.isLoading = false;
          this.registerForm.reset();
        },
        error: (err) => {
